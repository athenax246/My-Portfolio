...
const inputStyleMappingClasses = {
  small: 'opsourceTextField-inputSizeSmall',
  medium: 'opsourceTextField-inputSizeMedium',
  large: 'opsourceTextField-inputSizeLarge',
  xlarge: 'opsourceTextField-inputSizeXLarge',
};

const classes = {
  root: 'opsourceTextField-root',
  input: 'opsourceTextField-input',
  inputBorder: 'opsourceTextField-inputBorder',
};
...
export interface opsourceTextFieldProps
  extends Omit<FilledTextFieldProps | StandardTextFieldProps, 'size'> {
  noBorder?: boolean;
  size?: 'small' | 'medium' | 'large' | 'xlarge';
}

function TextField(props: opsourceTextFieldProps) {
  const {
    InputProps = {},
    InputLabelProps,
    noBorder,
